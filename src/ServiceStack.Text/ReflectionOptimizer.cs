...
//#endif
        ...
        public abstract MemberGetter CreateGetter(PropertyInfo propertyInfo);
        public abstract MemberGetter<T> CreateGetter<T>(PropertyInfo propertyInfo);
        public abstract MemberSetter CreateSetter(PropertyInfo propertyInfo);
        public abstract MemberSetter<T> CreateSetter<T>(PropertyInfo propertyInfo);
        
        public abstract MemberGetter CreateGetter(FieldInfo fieldInfo);
        public abstract MemberGetter<T> CreateGetter<T>(FieldInfo fieldInfo);
        public abstract MemberSetter CreateSetter(FieldInfo fieldInfo);
        public abstract MemberSetter<T> CreateSetter<T>(FieldInfo fieldInfo);
        
        public abstract MemberRefSetter<T> CreateSetterRef<T>(FieldInfo fieldInfo);
    ...
    public sealed class RuntimeReflectionOptimizer : ReflectionOptimizer
    {
        ...
        public override MemberGetter CreateGetter(FieldInfo fieldInfo) => fieldInfo.GetValue;
        public override MemberGetter<T> CreateGetter<T>(FieldInfo fieldInfo) => x => fieldInfo.GetValue(x);
        public override MemberSetter CreateSetter(FieldInfo fieldInfo) => fieldInfo.SetValue;
        public override MemberSetter<T> CreateSetter<T>(FieldInfo fieldInfo) => (o,x) => fieldInfo.SetValue(o,x);
    ...
    public sealed class ExpressionReflectionOptimizer : ReflectionOptimizer
    {
        ...
        public static Expression<MemberGetter> GetExpressionLambda(PropertyInfo propertyInfo)
        {
            var getMethodInfo = propertyInfo.GetGetMethod(nonPublic:true);
            if (getMethodInfo == null) return null;
            ...
            return Expression.Lambda<MemberGetter>
            (
        ...
        public static Expression<MemberGetter<T>> GetExpressionLambda<T>(PropertyInfo propertyInfo)
        {
            ...
            return Expression.Lambda<MemberGetter<T>>(convertProperty, instance);
        }
        ...
        public static Expression<MemberSetter<T>> SetExpressionLambda<T>(PropertyInfo propertyInfo)
        {
            var mi = propertyInfo.GetSetMethod(nonPublic: true);
            ...
            return Expression.Lambda<MemberSetter<T>>
            (
        ...
        public override MemberGetter CreateGetter(FieldInfo fieldInfo)
        {
            ...
            var fieldGetterFn = Expression.Lambda<MemberGetter>
                (
                    oExprCallFieldGetFn,
                    oInstanceParam
                )
        ...
        public override MemberSetter CreateSetter(FieldInfo fieldInfo)
        {
            ...
            var setterFn = Expression.Lambda<MemberSetter>(
        ...
        public override MemberRefSetter<T> CreateSetterRef<T>(FieldInfo fieldInfo)
        {
            ...
            return Expression.Lambda<MemberRefSetter<T>>
            (
                setterCall, instance, argument
            ).Compile();
        }
