...
namespace ServiceStack
{
    ...
    public static class PropertyInvoker
    {
        ...
        {
            return propertyInfo.GetValue(obj, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static, null, null, null);
        }
        internal static void SetValue(this PropertyInfo propertyInfo, Object obj, Object value)
        {
            propertyInfo.SetValue(obj, value, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static, null, null, null);
        }
#endif
