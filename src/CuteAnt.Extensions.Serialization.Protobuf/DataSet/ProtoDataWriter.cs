...
namespace CuteAnt.Extensions.Serialization.Protobuf
{
  ...
  public class ProtoDataWriter : IProtoDataWriter
  {
    ...
    {
      Serialize(stream, dataSet.CreateDataReader(), ProtoDataWriterOptions.Default);
    }
    ...
    {
      Serialize(stream, dataTable.CreateDataReader(), ProtoDataWriterOptions.Default);
    }
    ...
    public void Serialize(Stream stream, IDataReader reader, ProtoDataWriterOptions options)
    {
      ...
      options = options ?? ProtoDataWriterOptions.Default;
