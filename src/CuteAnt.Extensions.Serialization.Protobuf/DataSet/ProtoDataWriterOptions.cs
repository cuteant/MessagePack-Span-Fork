...
namespace CuteAnt.Extensions.Serialization.Protobuf
{
  ...
  /// <summary>Sets custom serialization options for the <see cref="ProtoDataWriter"/>.</summary>
  public sealed class ProtoDataWriterOptions : IEquatable<ProtoDataWriterOptions>
  {
    /// <summary>Default</summary>
    public static readonly ProtoDataWriterOptions Default = new ProtoDataWriterOptions();

    /// <summary>Gets or sets a value indicating whether zero-length arrays were
