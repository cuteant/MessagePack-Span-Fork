...
namespace CuteAnt.Extensions.Serialization.Protobuf
{
  ...
  /// <summary>Exception thrown when a <see cref="System.Data.IDataReader"/> with a field
  /// of an unsupported type is attempted to be serialized.</summary>
  [Serializable]
  public sealed class UnsupportedColumnTypeException : Exception
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="UnsupportedColumnTypeException"/> class.</summary>
    ...
    /// <summary>Gets the <see cref="System.Type"/> that was attempted to be serialized.</summary>
