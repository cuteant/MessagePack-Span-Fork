...
namespace CuteAnt.Extensions.Serialization
{
  ...
  public class BsonMessageSerializer : BaseJsonMessageSerializer
  {
    #region @@ Fields @@

    /// <summary>The default singlegton instance</summary>
    public static readonly BsonMessageSerializer DefaultInstance = new BsonMessageSerializer();
    ...
    /// <summary>Initializes a new instance of the <see cref="BsonMessageSerializer"/> class.</summary>
    public BsonMessageSerializer()
    {
    }

    /// <summary>Initializes a new instance of the <see cref="BsonMessageSerializer"/> class.</summary>
    /// <param name="formatter">The <see cref="BsonMessageSerializer"/> instance to copy settings from.</param>
    protected BsonMessageSerializer(BsonMessageSerializer formatter)
      : base(formatter)
    {
    }
