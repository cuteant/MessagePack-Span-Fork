...
{
	/// <summary>Utility class for creating and unwrapping <see cref="Exception"/> instances.</summary>
	internal static class Error
	{
		...
		/// <summary>Creates an <see cref="ArgumentException"/> with the provided properties.</summary>
		...
		/// <summary>Creates an <see cref="ArgumentNullException"/> with the provided properties.</summary>
		/// <returns>The logged <see cref="Exception"/>.</returns>
		...
		/// <summary>Creates an <see cref="ArgumentException"/> with a default message.</summary>
		/// <param name="parameterName">The name of the parameter that caused the current exception.</param>
		/// <returns>The logged <see cref="Exception"/>.</returns>
		...
		/// <summary>Creates an <see cref="ArgumentOutOfRangeException"/> with the provided properties.</summary>
		/// <param name="parameterName">The name of the parameter that caused the current exception.</param>
		...
		/// <summary>Creates an <see cref="ArgumentOutOfRangeException"/> with a message saying that the argument must be greater than or equal to <paramref name="minValue"/>.</summary>
		/// <param name="parameterName">The name of the parameter that caused the current exception.</param>
		/// <param name="actualValue">The value of the argument that causes this exception.</param>
		...
		/// <summary>Creates an <see cref="ArgumentOutOfRangeException"/> with a message saying that the argument must be less than or equal to <paramref name="maxValue"/>.</summary>
		/// <param name="parameterName">The name of the parameter that caused the current exception.</param>
		/// <param name="actualValue">The value of the argument that causes this exception.</param>
		...
		/// <summary>Creates an <see cref="KeyNotFoundException"/> with a message saying that the key was not found.</summary>
		/// <returns>The logged <see cref="Exception"/>.</returns>
		...
		/// <summary>Creates an <see cref="ObjectDisposedException"/> initialized according to guidelines.</summary>
		/// <param name="messageFormat">A composite format string explaining the reason for the exception.</param>
		/// <param name="messageArgs">An object array that contains zero or more objects to format.</param>
		/// <returns>The logged <see cref="Exception"/>.</returns>
		...
		/// <summary>Creates an <see cref="OperationCanceledException"/> initialized with the provided parameters.</summary>
		/// <returns>The logged <see cref="Exception"/>.</returns>
		...
		/// <summary>Creates an <see cref="ArgumentException"/> for an invalid enum argument.</summary>
		/// <param name="parameterName">The name of the parameter that caused the current exception.</param>
...
//#endif
		...
		/// <summary>Creates an <see cref="NotSupportedException"/>.</summary>
		/// <param name="messageFormat">A composite format string explaining the reason for the exception.</param>
		/// <param name="messageArgs">An object array that contains zero or more objects to format.</param>
		/// <returns>The logged <see cref="Exception"/>.</returns>
