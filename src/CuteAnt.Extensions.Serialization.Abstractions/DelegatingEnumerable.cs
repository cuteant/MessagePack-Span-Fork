...
{
	/// <summary>Helper class to serialize <see cref="IEnumerable{T}"/> types by delegating them through a concrete implementation."/>.</summary>
	...
	public sealed class DelegatingEnumerable<T> : IEnumerable<T>
	{
		...
		/// <summary>Initialize a DelegatingEnumerable. This constructor is necessary for <see cref="System.Runtime.Serialization.DataContractSerializer"/> to work.</summary>
		public DelegatingEnumerable()
		{
			_source = Enumerable.Empty<T>();
		}

		/// <summary>Initialize a DelegatingEnumerable with an <see cref="IEnumerable{T}"/>. This is a helper class to proxy <see cref="IEnumerable{T}"/> interfaces for <see cref="System.Xml.Serialization.XmlSerializer"/>.</summary>
		...
		/// <summary>Get the enumerator of the associated <see cref="IEnumerable{T}"/>.</summary>
