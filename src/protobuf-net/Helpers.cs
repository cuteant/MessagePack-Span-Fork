  ...
  internal sealed class Helpers
  {
    ...
    public readonly static Type[] EmptyTypes =
        ...
        private static readonly Type[] knownTypes = new Type[] {
                ...
                typeof(DateTime), typeof(TimeSpan), typeof(Guid), typeof(CuteAnt.CombGuid), typeof(Uri),
        ...
        private static readonly ProtoTypeCode[] knownCodes = new ProtoTypeCode[] {
            ...
            ProtoTypeCode.DateTime, ProtoTypeCode.TimeSpan, ProtoTypeCode.Guid, ProtoTypeCode.CombGuid, ProtoTypeCode.Uri,
        ...
        public static ProtoTypeCode GetTypeCode(IKVM.Reflection.Type type)
        {
            ...
            switch(type.FullName)
            {
                ...
                case "CuteAnt.CombGuid": return ProtoTypeCode.CombGuid;
    ...
    internal static PropertyInfo GetProperty(Type type, string name, bool nonPublic)
    {
      ...
      //    nonPublic ? BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
      //              : BindingFlags.Instance | BindingFlags.Public);
      var pis = nonPublic ? type.GetInstanceProperties() : type.GetInstancePublicProperties();
      return Array.Find(pis, _ => string.Equals(_.Name, name, StringComparison.Ordinal));
    }
#endif
    ...
    internal static MemberInfo[] GetInstanceFieldsAndProperties(Type type, bool publicOnly)
    {
      ...
      PropertyInfo[] props = publicOnly ? type.GetInstancePublicProperties() : type.GetInstanceProperties();
      FieldInfo[] fields = publicOnly ? type.GetInstancePublicFields() : type.GetInstanceFields();
