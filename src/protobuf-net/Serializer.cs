...
namespace ProtoBuf
{
        ...
        class Serializer
  {
    ...
    {
      using (MemoryStream ms = CuteAnt.IO.MemoryStreamManager.GetStream())
      {
    ...
    public static void Serialize<T>(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context, T instance) where T : class, System.Runtime.Serialization.ISerializable
    {
      ...
      //using (MemoryStream ms = CuteAnt.IO.MemoryStreamManager.GetStream())
      using (var pooledStream = CuteAnt.Buffers.BufferManagerOutputStreamManager.Create())
      {
        var outputStream = pooledStream.Object;
        outputStream.Reinitialize(1024 * 2);
        RuntimeTypeModel.Default.Serialize(outputStream, instance, context);
        info.AddValue(ProtoBinaryField, outputStream.ToByteArray());
      }
    }
#endif
