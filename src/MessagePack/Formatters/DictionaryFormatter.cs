...
namespace MessagePack.Formatters
{
    ...
    {
        public void Serialize(ref MessagePackWriter writer, ref int idx, TDictionary value, IFormatterResolver formatterResolver)
        {
            ...
            writer.WriteMapHeader(count, ref idx);
            ...
            try
            {
                ...
                {
                    var item = e.Current;
                    keyFormatter.Serialize(ref writer, ref idx, item.Key, formatterResolver);
                    valueFormatter.Serialize(ref writer, ref idx, item.Value, formatterResolver);
                }
            }
            finally
            {
        ...
        public TDictionary Deserialize(ref MessagePackReader reader, IFormatterResolver formatterResolver)
        {
