...
namespace ProtoBuf.unittest.Meta
{
    ...
    public class CombGuids
    {
        public class Data {
            public CombGuid Value {get;set;}
        ...
        public void TestRoundTripEmpty()
        {
            ...
            Data data = new Data { Value = CombGuid.Empty, SomeTailData = 'D' };
        ...
        public void TestRoundTripObviousBytes()
        {
            ...
            var model = BuildModel();
            Data data = new Data { Value = new CombGuid(expected), SomeTailData = 'F' };
        ...
        static void TestGuids(TypeModel model, int count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                Data data = new Data { Value = new CombGuid(buffer), SomeTailData = (char)rand.Next(1, ushort.MaxValue) };
