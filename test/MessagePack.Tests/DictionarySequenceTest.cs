...
{
    public class DictionarySequenceTest
    {
        T Convert<T>(T value)
        {
        ...
        {
            var helper = typeof(DictionarySequenceTest).GetTypeInfo().GetMethods(BindingFlags.NonPublic | BindingFlags.Instance).Single(m => m.Name == nameof(DictionaryTestAllHelper));
