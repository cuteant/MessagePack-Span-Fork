...
namespace SharedData
{
    ...
    public class DynamicArgumentTupleFormatter<T1, T2, T3, T4, T5, T6, T7, T8, T9> : IMessagePackFormatter<DynamicArgumentTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, ref int offset, DynamicArgumentTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> value, IFormatterResolver formatterResolver)
        {
            writer.WriteFixedArrayHeaderUnsafe(9, ref offset);
            formatterResolver.GetFormatterWithVerify<T1>().Serialize(ref writer, ref offset, value.Item1, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T2>().Serialize(ref writer, ref offset, value.Item2, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T3>().Serialize(ref writer, ref offset, value.Item3, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T4>().Serialize(ref writer, ref offset, value.Item4, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T5>().Serialize(ref writer, ref offset, value.Item5, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T6>().Serialize(ref writer, ref offset, value.Item6, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T7>().Serialize(ref writer, ref offset, value.Item7, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T8>().Serialize(ref writer, ref offset, value.Item8, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T9>().Serialize(ref writer, ref offset, value.Item9, formatterResolver);
        }
